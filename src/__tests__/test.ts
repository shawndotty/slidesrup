...
import { parseDesignPageDraft } from "../services/design-maker-parser";
import { generatePageMarkdown } from "../services/design-maker-generator";
...
function testTreeCircularDependency() {
	...
	assert.strictEqual(hasCircular, true, "Should detect circular dependency when dropping A into C");
