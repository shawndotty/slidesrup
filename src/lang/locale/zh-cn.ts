...
export default {
	...
	List: "列表",
	SubList: "子列表",
	"Use OBAS to Express Yourself": "用OBAS表达自己",
	Farewell: "再会",
	...
	OBAS_Assistant_Settings_Heading: "OBAS助手设置",
	"OBAS Running Language": "OBAS运行语言",
	...
	"Use User Typography Setting": "使用用户字体设置",
	...
	"Enable User Typography Setting": "启用用户字体设置",
