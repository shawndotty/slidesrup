...
export default {
	LicensePurchaseInfo:
		"您需要購買許可證才能使用 SlidesRup 的所有功能。請聯繫作者獲取更多信息。",
	...
	"Slide Design AVH": "簡報設計AVH",
	"Slide Design B": "簡報設計B",
	"Slide Design BVH": "簡報設計BVH",
	"Slide Design C": "簡報設計C",
	"Slide Design CVH": "簡報設計CVH",
	"Slide Design D": "簡報設計D",
	"Slide Design DVH": "簡報設計DVH",
	"Slide Design E": "簡報設計E",
	"Slide Design EVH": "簡報設計EVH",
	"Slide Design F": "簡報設計F",
	"Slide Design FVH": "簡報設計FVH",
	"Slide Design G": "簡報設計G",
	"Slide Design GVH": "簡報設計GVH",
	"Slide Design H": "簡報設計H",
	"Slide Design HVH": "簡報設計HVH",
	"Slide Design": "簡報設計",
	...
	Coordinates: "座標",
	"Pixel Coordinates": "像素座標",
	"Percent Coordinates": "百分比座標",
	PX: "像素",
	Pct: "百分比",
	Rel: "相對",
	Glob: "全域",
	...
	"No Unsplash images found": "未找到 Unsplash 圖片",
	"Image Picker": "圖片選擇器",
	"Unsplash Picker": "Unsplash 圖片選擇器",
	"Type keyword and press Enter": "輸入關鍵字後按 Enter 搜尋",
	"Unsplash image": "Unsplash 圖片",
	"Searching Unsplash...": "正在搜尋 Unsplash...",
	"Unsplash random mode (no access key)":
		"未設定 Access Key，已切換隨機單圖模式",
	"Select image to insert": "請選擇一張圖片插入",
	"Failed to load Unsplash images": "載入 Unsplash 圖片失敗",
	"Ratio presets": "比例預設",
	"Custom ratio": "自訂比例",
	"Current ratio": "目前比例",
	"Crop size": "裁切尺寸",
	"Use custom ratio": "使用自訂比例",
	"Invalid ratio, fallback to 16:9": "比例無效，已回退到 16:9",
	"Pin picker": "置頂選擇器",
	"Unpin picker": "取消置頂",
	"Close picker": "關閉選擇器",
	"Enter to insert · Esc to close": "Enter 插入 · Esc 關閉",
	...
	"AI Assistant": "AI 助手",
	"AI Provider": "AI 服務提供商",
	"Select AI provider protocol": "選擇 AI 提供商協議",
	"OpenAI Compatible": "OpenAI 相容介面",
	"AI Provider API Key": "AI 服務 API Key",
	"API key is stored in Obsidian keychain":
		"API Key 已儲存在 Obsidian 鑰匙圈",
	"Keychain unavailable, API key will fallback to plugin settings":
		"鑰匙圈不可用，API Key 將回退儲存至外掛設定",
	"Enter API Key": "輸入 API Key",
	"AI Inline Style Assistant": "AI 內聯樣式助手",
	"Generate Filter with AI": "AI 生成濾鏡",
	"Describe desired style effect": "描述你想要的樣式效果",
	...
	"Example: make text white, add blur glass background and rounded corners":
		"範例：讓文字變白、加入毛玻璃背景和圓角",
	"Generated inline style": "生成的內聯樣式",
	...
	"Unsplash Image Source": "Unsplash 圖源",
	"Unsplash ratio presets": "Unsplash 比例預設",
	...
	"Default crop height for inserted images": "插入圖片的預設裁切高度",
	"Unsplash Access Key": "Unsplash Access Key",
	"Enter Access Key": "輸入 Access Key",
	"CSS Class": "CSS 類名",
	"Inline Style": "內聯樣式",
	"Page Source": "頁面原始碼",
