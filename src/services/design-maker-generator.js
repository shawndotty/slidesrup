...
exports.syncDraftRawMarkdown = exports.generateDesignMakerRuntimeCss = exports.generateThemeCss = exports.generatePageMarkdown = void 0;
function formatRectValue(value) {
    return "".concat(Math.round(value));
}
function serializeAttributes(block, defaultRectUnit) {
    var rectUnit = block.extraAttributes.rectUnit === "px" ? "px" : defaultRectUnit;
    var attrs = {
        drag: rectUnit === "px"
            ? "".concat(formatRectValue(block.rect.width), "px ").concat(formatRectValue(block.rect.height), "px")
            : "".concat(formatRectValue(block.rect.width), " ").concat(formatRectValue(block.rect.height)),
        drop: rectUnit === "px"
            ? "".concat(formatRectValue(block.rect.x), "px ").concat(formatRectValue(block.rect.y), "px")
            : "".concat(formatRectValue(block.rect.x), " ").concat(formatRectValue(block.rect.y))
    };
...
function generateGridBlock(block, defaultRectUnit) {
    ...
    var innerContent = [block.content, childrenStr]
        .filter(Boolean)
        .join("\n\n");
    return "<grid ".concat(serializeAttributes(block, rectUnit), ">\n").concat(innerContent, "\n</grid>");
}
...
function generateDesignMakerRuntimeCss(theme) {
    var _a;
    var root = ":where(.slides-rup-design-maker-canvas, .slides-rup-design-maker-preview)";
    var generatedCss = "\n".concat(root, " {\n\t--sr-dm-primary: ").concat(theme.primaryColor, ";\n\t--sr-dm-secondary: ").concat(theme.secondaryColor, ";\n\t--sr-dm-background: ").concat(theme.backgroundColor, ";\n\t--sr-dm-text: ").concat(theme.textColor, ";\n\t--sr-dm-heading-font: ").concat(theme.headingFont, ";\n\t--sr-dm-body-font: ").concat(theme.bodyFont, ";\n\t--sr-dm-heading-scale: ").concat(theme.headingScale, ";\n\t--sr-dm-body-scale: ").concat(theme.bodyScale, ";\n\t--sr-dm-radius: ").concat(theme.borderRadius, "px;\n\t--sr-dm-shadow-opacity: ").concat(theme.shadowOpacity, ";\n\t--sr-dm-mode: ").concat(theme.mode, ";\n}\n\n").concat(root, " .bg-with-back-color {\n\tbackground: var(--sr-dm-primary);\n\tcolor: #ffffff;\n}\n\n").concat(root, " .bg-with-front-color {\n\tbackground: color-mix(in srgb, var(--sr-dm-background) 90%, var(--sr-dm-secondary) 10%);\n\tcolor: var(--sr-dm-text);\n\tborder-radius: var(--sr-dm-radius);\n\tbox-shadow: 0 18px 40px rgba(15, 23, 42, var(--sr-dm-shadow-opacity));\n}\n\n").concat(root, " .has-dark-background {\n\tcolor: #ffffff;\n}\n\n").concat(root, " .has-light-background {\n\tcolor: var(--sr-dm-text);\n}\n").trim();
    var tail = ((_a = theme.rawCss) === null || _a === void 0 ? void 0 : _a.trim()) ? "\n\n".concat(theme.rawCss.trim(), "\n") : "\n";
    return "".concat(generatedCss).concat(tail);
}
exports.generateDesignMakerRuntimeCss = generateDesignMakerRuntimeCss;
